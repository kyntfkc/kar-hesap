          ...
          <div className="flex items-center justify-between gap-3 flex-wrap">
            <div className="flex items-center gap-2">
              <div className="relative">
                <input
                  ...
                  className="w-32 px-3 py-2.5 text-sm border border-slate-300/70 rounded-lg focus:ring-2 focus:ring-amber-300/40 focus:border-amber-400 bg-white transition-all font-medium text-slate-900 hover:border-slate-400 shadow-sm"
                  placeholder="0,00"
                />
              ...
              className={`px-2.5 py-1.5 text-xs rounded-lg border transition-colors ${lengthOption === '50' ? 'bg-amber-400 text-slate-800 border-amber-400' : 'bg-white text-slate-700 border-slate-300 hover:border-slate-400'}`}
            >
              50 cm Zincir
            </button>
            <button
              ...
              className={`px-2.5 py-1.5 text-xs rounded-lg border transition-colors ${lengthOption === '60' ? 'bg-amber-400 text-slate-800 border-amber-400' : 'bg-white text-slate-700 border-slate-300 hover:border-slate-400'}`}
            >
              60 cm Zincir
            </button>
            </div>
            ...
            <div className="flex items-center gap-2 bg-slate-50/80 px-2.5 py-1.5 rounded-lg border border-slate-200">
              ...
              <input
                ...
                className={`w-20 px-2 py-1 text-xs border border-slate-300/70 rounded-md focus:ring-1 focus:ring-amber-300 focus:border-amber-400 bg-white shadow-sm disabled:bg-slate-100 disabled:text-slate-400 disabled:cursor-not-allowed ${expenses.specialPackaging === 0 ? 'pointer-events-none opacity-60' : ''}`}
                placeholder="150"
              />
              ...
              <div className="grid grid-cols-4 gap-2">
                <div className="col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-2.5 py-2 text-sm border border-slate-300/70 rounded-lg focus:ring-2 focus:ring-amber-300 focus:border-amber-400 bg-white shadow-sm"
                    placeholder="0.050"
                  />
                </div>
            ...
            <div className="grid grid-cols-4 gap-2 items-end">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateExpenses('shipping', parseFloat(e.target.value) || 0)}
                    className="h-9 w-full px-2 pr-8 text-sm border border-slate-300/70 rounded-lg focus:ring-2 focus:ring-amber-300 focus:border-amber-400 bg-white text-center shadow-sm"
                />
              ...
              <div>
                ...
                <input
                  ...
                  className="h-9 w-full px-2 text-sm border border-slate-300/70 rounded-lg focus:ring-2 focus:ring-amber-300 focus:border-amber-400 bg-white text-center shadow-sm"
                  placeholder="1.00"
                />
              </div>
            </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={addPlatform}
              className="flex items-center gap-1 px-2 py-1 text-xs font-medium text-amber-500 hover:text-amber-600 hover:bg-amber-50/50 rounded-lg transition-all"
            ...
            <button
              ...
              className="flex items-center gap-1 px-2 py-1 text-xs font-medium text-yellow-500 hover:text-yellow-600 hover:bg-yellow-50/50 rounded-lg transition-all"
            ...
            <div className="space-y-1.5">
              <div className="relative">
                <input
                  ...
                  className="w-full px-2 py-1.5 pr-8 text-sm border border-slate-300/70 rounded-lg focus:ring-2 focus:ring-amber-300 focus:border-amber-400 bg-white font-medium text-slate-900 text-center shadow-sm disabled:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-500"
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-2 py-1.5 text-sm border border-slate-300/70 rounded-lg focus:ring-2 focus:ring-amber-300 focus:border-amber-400 bg-white text-center font-semibold shadow-sm"
                      placeholder="0"
                    />
                  </div>
                  <div>
                ...
                <label className="block text-xs text-slate-600 mb-1 font-medium">
                  ...
                  <div className="relative">
                    <input
                      ...
                      disabled={platform.name === 'Standart' || platform.name === 'Astarlı Ürün'}
                      className="w-full pr-8 px-2 py-1.5 text-sm border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-300 focus:border-amber-400 bg-white text-center font-semibold disabled:bg-gray-100 disabled:cursor-not-allowed disabled:text-gray-500"
                      placeholder="0"
                    />
                    <span className="absolute right-2 top-1/2 -translate-y-1/2 text-xs text-slate-500 font-medium">TL</span>
                  </div>
