...
function ProfitCalculator() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 px-3 sm:px-0 pb-24">
      ...
      <div className="order-2 md:order-1 card p-4 sm:p-6 hover:shadow-2xl hover:shadow-blue-600/20 transition-all duration-300">
        <InputForm
      ...
      <div className="order-3 md:order-2 space-y-3">
        ...
        <div className="card p-4 sm:p-6 overflow-y-auto overflow-x-hidden hover:shadow-2xl hover:shadow-blue-600/20 transition-all duration-300">
        {isCalculating ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-slate-400">
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-blue-100 to-indigo-100 flex items-center justify-center mb-4 shadow-lg shadow-blue-200/30">
                ...
                {savedCalculations
                  ...
                  return (
                    <tr
                      ...
                      className={`odd:bg-slate-50/60 even:bg-white hover:bg-blue-50/60 transition-colors ${dragIndex===idx ? 'ring-2 ring-blue-300 bg-blue-100/80' : ''}`}
                    >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative w-full max-w-sm bg-white rounded-xl shadow-2xl border border-slate-200 p-5">
            ...
            <div className="flex items-center justify-end gap-2">
              ...
              <button onClick={confirmSaveScenario} disabled={!saveModalName.trim()} className="px-3 py-1.5 text-sm rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-lg shadow-blue-600/30 hover:shadow-xl hover:shadow-blue-600/40 disabled:opacity-50 disabled:shadow-none transition-all">Kaydet</button>
            </div>
          </div>
        </div>
      )}
