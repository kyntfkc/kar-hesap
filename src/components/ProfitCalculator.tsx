...
function ProfitCalculator() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 px-3 sm:px-0 pb-24">
      ...
      <div className="order-2 md:order-1 card p-4 sm:p-6 hover:shadow-2xl hover:shadow-amber-500/10 transition-all duration-300">
        <InputForm
      ...
      <div className="order-3 md:order-2 space-y-3">
        ...
        <div className="card p-4 sm:p-6 overflow-y-auto overflow-x-hidden hover:shadow-2xl hover:shadow-amber-300/10 transition-all duration-300">
        {isCalculating ? (
                ...
                {savedCalculations
                  ...
                  return (
                    <tr
                      ...
                      className={`odd:bg-slate-50/60 even:bg-white hover:bg-amber-50/60 transition-colors ${dragIndex===idx ? 'ring-2 ring-amber-300 bg-amber-50' : ''}`}
                    >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative w-full max-w-sm bg-white rounded-xl shadow-2xl border border-slate-200 p-5">
            ...
            <div className="flex items-center justify-end gap-2">
              ...
              <button onClick={confirmSaveScenario} disabled={!saveModalName.trim()} className="px-3 py-1.5 text-sm rounded-lg bg-amber-600 text-white disabled:bg-amber-300">Kaydet</button>
            </div>
          </div>
        </div>
      )}
