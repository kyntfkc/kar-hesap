        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-3 py-2 text-sm border border-slate-300/70 rounded-xl focus:ring-2 focus:ring-blue-600/40 focus:border-blue-600 bg-white transition-all font-medium text-slate-900 hover:border-blue-500 shadow-sm"
              placeholder="0"
            />
